...
public class BaseHttpClient {
	...
	protected void getServerURL() {
	    ServiceInfo socketInfo = ConsulServiceMgr.getHealthlyServiceByNm(serverName);// Consul中获取服务信息
		url = new StringBuffer("http://");
		url.append(socketInfo.getAddr()).append(":").append(socketInfo.getPort()).append(basePath.toString());
