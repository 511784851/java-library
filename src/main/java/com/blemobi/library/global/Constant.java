...
public class Constant  {
	...
	private static List<String> errorAccount = new ArrayList<String>();
	private static List<String> errorLogin = new ArrayList<String>();
	private static List<String> errorNews = new ArrayList<String>();
	private static List<String> errorOss = new ArrayList<String>();
	private static List<String> errorComment = new ArrayList<String>();
	
	private static String[][] socialInfo = null;
	private static List<String> errorSocial = new ArrayList<String>();
	...
	private static ConsulChangeListener adapter = new ConsulChangeListener(){
		...
		public void onEnvChange(Map<String, String> prop) {
			...
			try{
				...
				redisMaxConnectNum = Integer.parseInt(prop.get(KEY_REDIS_MAX_CONNECT_NUM)); // 定义redis连接池的最大连接数
	 ...
	 * @return 返回“健康正常好友服务”的服务器信息。String[0]为IP地址，String[1]为端口。
	 */
...
//		return new String[]{"192.168.1.241","9008"};// 好友系统IP和port信息
	...
	/**
	 * 获取jesry容器中允许访问的包名目录。默认值是com.blemobi.chat.rest。
	 * @return 授权访问的包名。
	 */
